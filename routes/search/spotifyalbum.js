...
// Ruta de búsqueda personalizada para Spotify Album
router.get('/search/spotifyalbum', async (req, res) => {
    ...
    try {
        const apiURL = `https://delirius-apiofc.vercel.app/search/spotifyalbum?q=${encodeURIComponent(query)}&limit=${limit}`;
