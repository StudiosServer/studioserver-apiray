...
router.get('/tools/telegramorg', async (req, res) => {
    ...
    try {
        const apiURL = `https://delirius-apiofc.vercel.app/tools/telegramorg?url=${encodeURIComponent(query)}&filename=${encodeURIComponent(filename)}`;
