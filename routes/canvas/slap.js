...
router.get('/canvas/slap', async (req, res) => {
    ...
    try {
        const apiURL = `https://delirius-apiofc.vercel.app/canvas/slap?url1=${encodeURIComponent(query1)}&url2=${encodeURIComponent(query2)}`;
