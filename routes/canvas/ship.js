...
router.get('/canvas/ship', async (req, res) => {
    ...
    try {
        const apiURL = `https://delirius-apiofc.vercel.app/canvas/ship?image1=${encodeURIComponent(query1)}&name1=${encodeURIComponent(name1)}&image2=${encodeURIComponent(query2)}&name2=${encodeURIComponent(name2)}&percentage=${encodeURIComponent(porcentage)}&text=${encodeURIComponent(text)}`;
